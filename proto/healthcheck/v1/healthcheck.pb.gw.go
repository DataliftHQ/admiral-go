...
func RegisterHealthcheckAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HealthcheckAPIServer) error {
	...
	mux.Handle(http.MethodGet, pattern_HealthcheckAPI_Healthcheck_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/admiral.api.healthcheck.v1.HealthcheckAPI/Healthcheck", runtime.WithHTTPPathPattern("/healthz"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterHealthcheckAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HealthcheckAPIClient) error {
	...
	mux.Handle(http.MethodGet, pattern_HealthcheckAPI_Healthcheck_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/admiral.api.healthcheck.v1.HealthcheckAPI/Healthcheck", runtime.WithHTTPPathPattern("/healthz"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
