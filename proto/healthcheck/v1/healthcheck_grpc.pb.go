...
const (
	HealthcheckAPI_Healthcheck_FullMethodName = "/admiral.api.healthcheck.v1.HealthcheckAPI/Healthcheck"
)
...
func RegisterHealthcheckAPIServer(s grpc.ServiceRegistrar, srv HealthcheckAPIServer) {
	// If the following call panics, it indicates UnimplementedHealthcheckAPIServer was
...
var HealthcheckAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admiral.api.healthcheck.v1.HealthcheckAPI",
